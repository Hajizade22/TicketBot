...
public class PlaceService {
    public String places() throws IOException {
        ...
        return filteredVenuesArray.toString(2).replace("\n", System.lineSeparator());
    }


    public String map(int venueId) throws IOException {
        ...
        List<JSONObject> venueDetailsList = StreamSupport.stream(venuesArray.spliterator(), true).map(obj -> (JSONObject) obj).filter(v -> v.getInt("id") == venueId).map(venue -> {
            JSONObject result = new JSONObject();
    ...
    public String phone(int venueId) throws IOException {
    ...
    public String mobile(int venueId) throws IOException {
